// test_count_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module test_count_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> led_pio_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // led_pio_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire  [17:0] seven_seg_pio_s1_agent_m0_address;                                                  // seven_seg_pio_s1_agent:m0_address -> seven_seg_pio_s1_translator:uav_address
	...
	wire  [94:0] seven_seg_pio_s1_agent_rf_source_data;                                              // seven_seg_pio_s1_agent:rf_source_data -> seven_seg_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] seven_seg_pio_s1_agent_rsp_fifo_out_data;                                           // seven_seg_pio_s1_agent_rsp_fifo:out_data -> seven_seg_pio_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> seven_seg_pio_s1_agent:cp_valid
	wire  [93:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> seven_seg_pio_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // seven_seg_pio_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> seven_seg_pio_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> seven_seg_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> seven_seg_pio_s1_agent:cp_endofpacket
	...
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> button_pio_s1_agent:cp_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> ROM_s1_agent:cp_data
	...
	wire  [93:0] led_pio_s1_agent_rp_data;                                                           // led_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire         seven_seg_pio_s1_agent_rp_valid;                                                    // seven_seg_pio_s1_agent:rp_valid -> router_004:sink_valid
	wire  [93:0] seven_seg_pio_s1_agent_rp_data;                                                     // seven_seg_pio_s1_agent:rp_data -> router_004:sink_data
	wire         seven_seg_pio_s1_agent_rp_ready;                                                    // router_004:sink_ready -> seven_seg_pio_s1_agent:rp_ready
	wire         seven_seg_pio_s1_agent_rp_startofpacket;                                            // seven_seg_pio_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         seven_seg_pio_s1_agent_rp_endofpacket;                                              // seven_seg_pio_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [93:0] button_pio_s1_agent_rp_data;                                                        // button_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] rom_s1_agent_rp_data;                                                               // ROM_s1_agent:rp_data -> router_007:sink_data
	...
	wire         seven_seg_pio_s1_agent_rdata_fifo_src_valid;                                        // seven_seg_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] seven_seg_pio_s1_agent_rdata_fifo_src_data;                                         // seven_seg_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         seven_seg_pio_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_002:in_0_ready -> seven_seg_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> seven_seg_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> seven_seg_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // seven_seg_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> seven_seg_pio_s1_agent:rdata_fifo_sink_error
	...
	test_count_mm_interconnect_0_router router (
	...
	test_count_mm_interconnect_0_router_001 router_001 (
	...
	test_count_mm_interconnect_0_router_002 router_002 (
	...
	test_count_mm_interconnect_0_router_003 router_003 (
	...
	test_count_mm_interconnect_0_router_003 router_004 (
	...
	test_count_mm_interconnect_0_router_003 router_005 (
	...
	test_count_mm_interconnect_0_router_003 router_006 (
	...
	test_count_mm_interconnect_0_router_007 router_007 (
	...
	test_count_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_count_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
